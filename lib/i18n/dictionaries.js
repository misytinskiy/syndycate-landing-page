...
export const dictionaries = {
  "en": {
    ...
    "stats": {
      ...
      "description": "WE ARE HAPPY TO PROVIDE YOU WITH ALL OUR COMPETENCIES AND MANY YEARS OF EXPERIENCE TO ACHIEVE YOUR FINANCIAL GOALS",
      "items": [
        {
          "id": "s1",
          "value": "28",
          "note": "(01)",
          "description": "THEORETICAL & PRACTICAL MODULES DESIGNED FOR REAL TRADING RESULTS",
          "area": "cell1"
        },
        {
          "id": "s2",
          "value": "90+",
          "note": "(02)",
          "description": "HOURS OF LIVE ONLINE SESSIONS WITH MENTORS (RECORDINGS INCLUDED)",
          "area": "cell2"
        },
        {
          "id": "s3",
          "value": "60",
          "note": "(03)",
          "description": "DAYS OF ACCESS TO A PRIVATE SYNDICATE COMMUNITY WITH MARKET UPDATES",
          "area": "cell3"
        },
        {
          "id": "s4",
          "value": "42",
          "note": "(04)",
          "description": "PRACTICAL ASSIGNMENTS WITH PERSONAL FEEDBACK + FINAL CERTIFICATION EXAM",
          "area": "cell4"
        }
      ]
    },
    ...
    "program": {
      ...
      "modules": [
        {
          "title": "Introduction",
          "answer": "Understanding what is trading, how it works, and your first steps."
        },
        {
          "title": "Market Structure",
          "answer": "Market Structure Range, strong and weak swings, advanced structure."
        },
        {
          "title": "Liquidity",
        ...
        },
        {
          ...
          "answer": "Market imbalance, efficient vs. inefficient price delivery, rebalancing and price interaction with gaps, IFVG."
        },
        {
          "title": "Supply & Demand",
          "answer": "Order Block, Blocks: Breaker, Mitigation, Rejection, Propulsion. \"buy to sell\" and \"sell to buy\" manipulation. Price delivery mechanics."
        },
        {
          "title": "Order Flow",
          "answer": "How price reacts to liquidity, order flow and its components, types of order flow, inducement, examples."
        },
        {
          "title": "Multi-Timeframe Analysis",
          "answer": "Effective chart analysis, optimal entry and target identification, recognition of key interest zones."
        },
        {
          "title": "Sessions / Part 1",
          "answer": "Optimal trading periods, liquidity across sessions, raids on previous session high/low, Asia/London and London/New York."
        },
        {
          "title": "Sessions / Part 2",
          "answer": "Session dynamics, workflow scheme, principle of operation based solely on liquidity and balance."
        },
        {
          "title": "Market Context",
          "answer": "How to identify context? Context interpretation from SNDCT mentors."
        },
        {
          "title": "Risk Management",
          "answer": "Risk/reward, how to calculate volume in TradingView for any asset, high vs low RR."
        },
        {
          "title": "Backtest",
        ...
        {
          "title": "Statics",
          "answer": "What is statics, statics in dynamics, how to create your own setup."
        },
        {
          "title": "Dynamics",
        ...
        },
        {
          ...
          "answer": "Creating your own trading strategy, optimization, trading strategy templates."
        },
        {
          "title": "Indices",
          "answer": "How to trade indices, correlations between indices. GER40, NAS100, S&P500."
        },
        {
          "title": "News",
          "answer": "Forex news calendar, how news affects the market, NFP/CPI reports, FOMC meetings."
        },
        {
          "title": "Useful",
          "answer": "AMD/PO3, SMT Divergence, causes of resweeps, price assignment, and spread."
        },
        {
          "title": "Technical Psychology",
          "answer": "Trading plan and rules, managing emotions during trading, risk management and psychology."
        },
        {
          "title": "Roadmap",
          "answer": "Turning knowledge into action: steps to take after completing your course."
        },
        {
          "title": "Crypto",
        ...
        {
          "title": "Forex Market",
          "answer": "Terminology, contract types, trading platforms, fundamentals of brokerage services, and market basics."
        },
        {
        ...
        },
        {
          ...
          "answer": "How to trade using 4H/15M charts? Understanding price action and key features."
        },
        {
          "title": "Gold & Indices - Differences from forex",
          "answer": "Timing manipulations, timing strategies for indices and gold, specifics of trading U.S. indices, and how to trade high risk/reward setups."
        },
        {
          "title": "Market Manipulations",
          "answer": "Why does sweep and reversal not happen? Reversals, why do we get BE and then TP? How to understand key fractals?"
        }
      ],
      "previewCount": 8
    },
    ...
    "results": {
      ...
      "bullets": [
        ...
        [
          "RECEIVE LIFETIME ACCESS TO UPDATED",
          "COURSE MATERIALS"
        ],
        [
    ...
    "faq": {
      ...
      "items": [
        ...
        },
        {
          ...
          "answer": "EVERY SESSION IS RECORDED. THE REPLAY WILL BE IN YOUR DASHBOARD WITHIN 24 H."
        },
        {
          "question": "I DON’T HAVE A TRADING DEPOSIT YET — WHAT SHOULD I DO?",
          "answer": "THE COURSE TEACHES RISK-FREE SIMULATION FIRST. YOU CAN START WITHOUT CAPITAL."
        },
        {
  ...
  "he": {
    ...
    "marquee": {
      "text": "לא צריך יותר זמן. צריך את המרחב הנכון."
    },
    "stats": {
      "tag": "<עלינו>",
      "title": {
      ...
      "description": "אנחנו כאן בשביל לשתף אתכם בכל מה שלמדנו מהניסיון שלנו – כדי שתוכלו להגיע למטרות הכלכליות שלכם",
      "items": [
        {
          "id": "s1",
          "value": "28",
        ...
        },
        {
          ...
          "value": "90+",
          "note": "(02)",
          "description": "90+ שעות של מפגשי אונליין עם מנטורים (כולל הקלטות)",
          "area": "cell2"
        },
        {
          "id": "s3",
          "value": "60",
          "note": "(03)",
          "description": "60 ימי גישה לקהילת Syndicate סגורה עם ניתוחי שוק",
          "area": "cell3"
        },
        {
          "id": "s4",
          "value": "42",
          "note": "(04)",
          "description": "42 משימות מעשיות עם פידבק אישי + מבחן הסמכה מסכם",
          "area": "cell4"
        }
      ]
    },
    ...
    "program": {
      ...
      "modules": [
        ...
        },
        {
          ...
          "answer": "אי־איזון בשוק, מסירת מחיר יעילה לעומת לא יעילה, ריבלנסינג ואיך המחיר מגיב לגאפים, IFVG."
        },
        {
          "title": "היצע וביקוש",
          "answer": "אזורי Order Block, בלוקים: breaker, mitigation, rejection, propulsion. מנגנוני \"buy to sell\" ו-\"sell to buy\". מנגנוני מסירת מחיר."
        },
        {
          "title": "זרימת הוראות (Order Flow)",
          "answer": "איך המחיר מגיב לנזילות, מה זה זרימת הוראות ומה המרכיבים שלה, סוגי זרימת הוראות, אינדוסמנט, דוגמאות."
        },
        {
          "title": "ניתוח רב-טיימפריים",
          "answer": "ניתוח גרפים יעיל, זיהוי נקודות כניסה ויעדים אופטימליים, והבנה באזורי עניין מרכזיים."
        },
        {
          "title": "סשנים / חלק 1",
          "answer": "זמני מסחר אופטימליים, נזילות בין סשנים, לקיחת נזילות מהשיא/שפל של הסשן הקודם, אסיה-לונדון ולונדון-ניו יורק."
        },
        {
          "title": "סשנים / חלק 2",
          "answer": "דינמיקה של הסשן, תרשים עבודה, עיקרון פעולה שמבוסס רק על נזילות ואיזון."
        },
        {
          "title": "הקשר שוק",
          "answer": "איך לזהות את הקונטקסט? פירוש הקונטקסט ע\"י המנטורים של Syndicate."
        },
        {
          "title": "ניהול סיכונים",
          "answer": "ניהול סיכונים, איך לחשב גודל פוזיציה לכל נכס, יחס סיכוי-סיכון גבוה מול נמוך."
        },
        {
          "title": "בק-טסט",
        ...
        },
        {
          ...
          "answer": "איך לבנות לעצמך אסטרטגיית מסחר, איך לשפר/לייעל אותה, ותבניות מוכנות לאסטרטגיות."
        },
        {
          "title": "מדדים",
          "answer": "איך לסחור מדדים, קשרי קורלציה בין מדדים, GER40, NAS100, S&P500."
        },
        {
          "title": "חדשות",
          "answer": "לוח חדשות פורקס, איך חדשות משפיעות על השוק, דוחות NFP/CPI, ישיבות ה-FOMC."
        },
        {
          "title": "שימושי",
        ...
        },
        {
          ...
          "answer": "תוכנית מסחר וכללי עבודה, איך לשלוט ברגשות בזמן מסחר, חיבור בין ניהול סיכונים לפסיכולוגיית מסחר."
        },
        {
          "title": "מפת דרכים",
        ...
        {
          "title": "מסחר נוסטרו",
          "answer": "מה זה מסחר בחברת נוסטרו, איך לבחור חברת נוסטרו שמתאימה לך, ושאלות נפוצות על נוסטרו."
        },
        {
          "title": "שוק הפורקס",
          "answer": "מונחים בסיסיים, סוגי חוזים, פלטפורמות מסחר, איך ברוקר עובד ומה הבסיס של השוק."
        },
        {
        ...
        },
        {
          ...
          "answer": "איך לסחור דרך גרפים 4h/15m, להבין את ה-price action והדגשים העיקריים בזהב."
        },
        {
          "title": "זהב ומדדים – במה הם שונים מפורקס",
          "answer": "מניפולציות של טיימינג, שיטות טיימינג למסחר במדדים ובזהב, מה מיוחד במסחר במדדים אמריקאיים, ואיך לסחור סטאפים עם יחס סיכוי-סיכון גבוה."
        },
        {
          "title": "מניפולציות בשוק",
          "answer": "למה לפעמים יש sweep אבל אין היפוך? למה יש היפוך אבל קודם מוציאים אותנו על BE ואז זה הולך ל-TP? איך לזהות ולקרוא פרקטלים חשובים."
        }
      ],
      "previewCount": 8
    },
    ...
    "results": {
      ...
      "bullets": [
        [
          "לבנות לעצמך אסטרטגיית מסחר מותאמת ומשופרת"
        ],
        [
          "להבין את הלוגיקה של השוק ברמה עמוקה יותר"
        ],
        [
          "לקבל גישה לכל חומרי הקורס המתעדכנים בלי הגבלה בזמן"
        ],
        [
          "להישאר בקשר עם המנטורים גם אחרי שהתוכנית נגמרת"
        ],
        [
          "להיכנס לקהילה סגורה של סוחרים"
        ]
      ],
      "cta": "שריין את המקום שלך"
    },
    ...
    "faq": {
      ...
      "items": [
        ...
        },
        {
          ...
          "answer": "מתחילים להתאמן על חשבון דמו / סימולטור בלי סיכון. אפשר להתחיל גם בלי כסף."
        },
        {
